...
ideas = [
  ...
  {title: "Spain", category: "biz-dev", short_desc: "We should open a branch office in Spain.", coffer: 0, user_id: 1, long_desc: "Brilla, brilla, estrellita, ¡Cómo me pregunto cuál usted es! Encima sobre del mundo tan arriba, Como un diamante en el cielo. Brilla, brilla, estrellita, ¡Cómo me pregunto cuál usted es! Brilla, brilla, estrellita, ¡Cómo me pregunto cuál usted es! Encima sobre del mundo tan arriba, Como un diamante en el cielo. Brilla, brilla, estrellita, ¡Cómo me pregunto cuál usted es!"},
  {title: "Germany", category: "biz-dev", short_desc: "We should open a branch office in Germany.", coffer: 0, user_id: 2, long_desc: "Twinkle, twinkle, little star, Wie ich frage mich, was du bist! Bis über die Welt so hoch, Wie ein Diamant im Himmel. Twinkle, twinkle, little star, Wie ich frage mich, was du bist! Twinkle, twinkle, little star, Wie ich frage mich, was du bist! Bis über die Welt so hoch, Wie ein Diamant im Himmel. Twinkle, twinkle, little star, Wie ich frage mich, was du bist!"},
  {title: "China", category: "biz-dev", short_desc: "We should open a branch office in China.", coffer: 0, user_id: 5, long_desc: "一闪一闪小星星我多想知道你是什么！了世界如此之高，像天空中的钻石。一闪一闪小星星我多想知道你是什么！一闪一闪小星星我多想知道你是什么！了世界如此之高，像天空中的钻石。一闪一闪小星星我多想知道你是什么！"},
  {title: "Italy", category: "biz-dev", short_desc: "We should open a branch office in Italy.", coffer: 4, user_id: 1, long_desc: "Twinkle, Twinkle, Little Star, Come mi chiedo che cosa sei! Sopra il mondo così in alto, come un diamante nel cielo. Twinkle, Twinkle, Little Star, Come mi chiedo che cosa sei! Twinkle, Twinkle, Little Star, Come mi chiedo che cosa sei! Sopra il mondo così in alto, come un diamante nel cielo. Twinkle, Twinkle, Little Star, Come mi chiedo che cosa sei!"},
  {title: "France", category: "biz-dev", short_desc: "We should open a branch office in France.", coffer: 0, user_id: 4, long_desc: "Twinkle, Twinkle, petite étoile, comment je me demande ce que vous êtes! Au-dessus du monde tellement haut, Comme un diamant dans le ciel. Twinkle, Twinkle, petite étoile, comment je me demande ce que vous êtes! Twinkle, Twinkle, petite étoile, comment je me demande ce que vous êtes! Au-dessus du monde tellement haut, Comme un diamant dans le ciel. Twinkle, Twinkle, petite étoile, comment je me demande ce que vous êtes!"},
